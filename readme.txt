...
= The CSS and JavaScript files located in the `frontend/admin/dist` directory are build files. These files are generated from the source files found in the `frontend/admin/source-files` directory.
